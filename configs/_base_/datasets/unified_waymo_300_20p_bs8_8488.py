...
train_pipeline = [
    ...
    dict(type="Lane3DResampler", num_points=20),
    # Augmentations
    dict(
...
collection_suffix = "filtered_300"
bin_name = "cam_gt_filtered_300.bin"  # only for test, please use "cam_gt_filtered.bin"
eval_kit_root = "RepVF/tools/waymo_utils/"  # "data/waymo/waymo-od/src/bazel-bin/waymo_open_dataset/metrics/tools/"
data = dict(
    samples_per_gpu=8,  # 2, 2:7.4G~ 4:13G~ flash: 2*4=6G 6*4=14G 4G
